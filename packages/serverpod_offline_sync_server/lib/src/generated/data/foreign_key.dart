...
import '../data/foreign_key_override_reason.dart' as _i3;
...
abstract class CrdtDataForeignKey
  ...
  factory CrdtDataForeignKey({
    ...
    required _i1.UuidValue? attemptedValue,
    _i1.UuidValue? visibleValue,
  ...
  factory CrdtDataForeignKey.fromJson(Map<String, dynamic> jsonSerialization) {
    return CrdtDataForeignKey(
      ...
      field: jsonSerialization['field'] == null
          ? null
          : _i4.Protocol().deserialize<_i2.CrdtDataField>(
...
class _CrdtDataForeignKeyImpl extends CrdtDataForeignKey {
  ...
  CrdtDataForeignKey copyWith({
    ...
    return CrdtDataForeignKey(
      ...
      attemptedValue: attemptedValue is _i1.UuidValue?
          ? attemptedValue
          : this.attemptedValue,
      visibleValue: visibleValue is _i1.UuidValue?
          ? visibleValue
          : this.visibleValue,
...
class CrdtDataForeignKeyUpdateTable
  ...
  _i1.ColumnValue<_i1.UuidValue, _i1.UuidValue> attemptedValue(
    _i1.UuidValue? value,
  ) => _i1.ColumnValue(
  ...
  _i1.ColumnValue<_i1.UuidValue, _i1.UuidValue> visibleValue(
    _i1.UuidValue? value,
  ) => _i1.ColumnValue(
    table.visibleValue,
    value,
