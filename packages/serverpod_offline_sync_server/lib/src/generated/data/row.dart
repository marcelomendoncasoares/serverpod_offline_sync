...
import '../data/deleted.dart' as _i7;
import '../data/field.dart' as _i8;
import '../data/row_visibility.dart' as _i3;
import '../node/node.dart' as _i6;
import '../node/scope.dart' as _i4;
import '../schema/table.dart' as _i5;
...
abstract class CrdtDataRow extends _i1.BaseHlc
  ...
  CrdtDataRow._({
    ...
    this.node,
    _i3.CrdtDataRowVisibility? visibility,
    this.deleted,
    this.fields,
  }) : visibility = visibility ?? _i3.CrdtDataRowVisibility.userInsert;
  ...
  factory CrdtDataRow({
    ...
    _i4.CrdtScope? scope,
    required int tblId,
    _i5.CrdtSchemaTable? tbl,
    required _i2.UuidValue uuidRowId,
    required int nodeId,
    _i6.CrdtNode? node,
    _i3.CrdtDataRowVisibility? visibility,
    _i7.CrdtDataDeleted? deleted,
    List<_i8.CrdtDataField>? fields,
  }) = _CrdtDataRowImpl;
  ...
  factory CrdtDataRow.fromJson(Map<String, dynamic> jsonSerialization) {
    return CrdtDataRow(
      ...
      node: jsonSerialization['node'] == null
          ? null
          : _i9.Protocol().deserialize<_i6.CrdtNode>(jsonSerialization['node']),
      visibility: jsonSerialization['visibility'] == null
          ? null
          : _i3.CrdtDataRowVisibility.fromJson(
              (jsonSerialization['visibility'] as int),
            ),
      deleted: jsonSerialization['deleted'] == null
          ? null
          : _i9.Protocol().deserialize<_i7.CrdtDataDeleted>(
              jsonSerialization['deleted'],
            ),
      fields: jsonSerialization['fields'] == null
          ? null
          : _i9.Protocol().deserialize<List<_i8.CrdtDataField>>(
  ...
  static CrdtDataRowInclude include({
    _i4.CrdtScopeInclude? scope,
    _i5.CrdtSchemaTableInclude? tbl,
    _i6.CrdtNodeInclude? node,
    _i7.CrdtDataDeletedInclude? deleted,
    _i8.CrdtDataFieldIncludeList? fields,
  }) {
...
class _CrdtDataRowImpl extends CrdtDataRow {
  ...
  CrdtDataRow copyWith({
    ...
    return CrdtDataRow(
      ...
      scope: scope is _i4.CrdtScope? ? scope : this.scope?.copyWith(),
      tblId: tblId ?? this.tblId,
      tbl: tbl is _i5.CrdtSchemaTable? ? tbl : this.tbl?.copyWith(),
      uuidRowId: uuidRowId ?? this.uuidRowId,
      nodeId: nodeId ?? this.nodeId,
      node: node is _i6.CrdtNode? ? node : this.node?.copyWith(),
      visibility: visibility ?? this.visibility,
      deleted: deleted is _i7.CrdtDataDeleted?
          ? deleted
          : this.deleted?.copyWith(),
      fields: fields is List<_i8.CrdtDataField>?
          ? fields
...
class CrdtDataRowUpdateTable extends _i2.UpdateTable<CrdtDataRowTable> {
  ...
  _i2.ColumnValue<_i2.UuidValue, _i2.UuidValue> uuidRowId(
    _i2.UuidValue value,
  ) => _i2.ColumnValue(
    table.uuidRowId,
    value,
  ...
  _i2.ColumnValue<_i3.CrdtDataRowVisibility, _i3.CrdtDataRowVisibility>
  visibility(_i3.CrdtDataRowVisibility value) => _i2.ColumnValue(
    table.visibility,
    value,
  );
}
...
class CrdtDataRowTable extends _i2.Table<int?> {
  ...
  /// Identifier for the scope that owns the data.
  _i4.CrdtScopeTable? _scope;

  late final _i2.ColumnInt tblId;

  /// Reference to the table this row belongs to.
  _i5.CrdtSchemaTableTable? _tbl;
  ...
  /// Updated by user tombstone writes and foreign key projection. Visible
  /// states are listed before hidden states in CrdtDataRowVisibility.
  late final _i2.ColumnEnum<_i3.CrdtDataRowVisibility> visibility;

  /// The synced user tombstone for this row.
  ///
  /// Only present after the first user visibility change event has been recorded.
  /// Projection may keep a visible [visibility] while a user delete tombstone exists.
  _i7.CrdtDataDeletedTable? _deleted;

  /// The fields for this row.
  _i8.CrdtDataFieldTable? ___fields;

  /// The fields for this row.
  _i2.ManyRelation<_i8.CrdtDataFieldTable>? _fields;

  _i4.CrdtScopeTable get scope {
    if (_scope != null) return _scope!;
    _scope = _i2.createRelationTable(
      relationFieldName: 'scope',
      field: CrdtDataRow.t.scopeId,
      foreignField: _i4.CrdtScope.t.id,
      tableRelation: tableRelation,
      createTable: (foreignTableRelation) =>
          _i4.CrdtScopeTable(tableRelation: foreignTableRelation),
    );
    return _scope!;
  }

  _i5.CrdtSchemaTableTable get tbl {
    if (_tbl != null) return _tbl!;
    _tbl = _i2.createRelationTable(
      relationFieldName: 'tbl',
      field: CrdtDataRow.t.tblId,
      foreignField: _i5.CrdtSchemaTable.t.id,
      tableRelation: tableRelation,
      createTable: (foreignTableRelation) =>
          _i5.CrdtSchemaTableTable(tableRelation: foreignTableRelation),
    );
    return _tbl!;
  }
  ...
  _i7.CrdtDataDeletedTable get deleted {
    if (_deleted != null) return _deleted!;
    _deleted = _i2.createRelationTable(
      relationFieldName: 'deleted',
      field: CrdtDataRow.t.id,
      foreignField: _i7.CrdtDataDeleted.t.rowId,
      tableRelation: tableRelation,
      createTable: (foreignTableRelation) =>
          _i7.CrdtDataDeletedTable(tableRelation: foreignTableRelation),
    );
    return _deleted!;
  }

  _i8.CrdtDataFieldTable get __fields {
    if (___fields != null) return ___fields!;
    ___fields = _i2.createRelationTable(
      relationFieldName: '__fields',
      field: CrdtDataRow.t.id,
      foreignField: _i8.CrdtDataField.t.rowId,
      tableRelation: tableRelation,
      createTable: (foreignTableRelation) =>
          _i8.CrdtDataFieldTable(tableRelation: foreignTableRelation),
    );
    return ___fields!;
  }

  _i2.ManyRelation<_i8.CrdtDataFieldTable> get fields {
    ...
    _fields = _i2.ManyRelation<_i8.CrdtDataFieldTable>(
      tableWithRelations: relationTable,
      table: _i8.CrdtDataFieldTable(
...
class CrdtDataRowInclude extends _i2.IncludeObject {
  ...
  _i4.CrdtScopeInclude? _scope;

  _i5.CrdtSchemaTableInclude? _tbl;

  _i6.CrdtNodeInclude? _node;

  _i7.CrdtDataDeletedInclude? _deleted;

  _i8.CrdtDataFieldIncludeList? _fields;
...
class CrdtDataRowAttachRepository {
  ...
  Future<void> fields(
    ...
    List<_i8.CrdtDataField> crdtDataField, {
    _i2.Transaction? transaction,
  }) async {
    ...
    var $crdtDataField = crdtDataField
        ...
        .toList();
    await session.db.update<_i8.CrdtDataField>(
      $crdtDataField,
      columns: [_i8.CrdtDataField.t.rowId],
      transaction: transaction,
    );
  }
}
...
class CrdtDataRowAttachRowRepository {
  ...
  Future<void> deleted(
    ...
    await session.db.updateRow<_i7.CrdtDataDeleted>(
      $deleted,
      columns: [_i7.CrdtDataDeleted.t.rowId],
      transaction: transaction,
    );
  }
  ...
  Future<void> fields(
    _i2.DatabaseSession session,
    CrdtDataRow crdtDataRow,
    _i8.CrdtDataField crdtDataField, {
    _i2.Transaction? transaction,
  }) async {
    ...
    await session.db.updateRow<_i8.CrdtDataField>(
      $crdtDataField,
      columns: [_i8.CrdtDataField.t.rowId],
      transaction: transaction,
    );
