...
class Protocol extends _i1.DatabaseSerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i1.getType<List<_i6.CrdtDataField>?>()) {
      return (data != null
              ? (data as List)
                    .map((e) => deserialize<_i6.CrdtDataField>(e))
                    .toList()
    ...
    if (t == _i1.getType<List<_i15.CrdtScopeNode>?>()) {
      return (data != null
              ? (data as List)
                    .map((e) => deserialize<_i15.CrdtScopeNode>(e))
                    .toList()
    ...
    if (t == List<_i3.Hlc>) {
      return (data as List).map((e) => deserialize<_i3.Hlc>(e)).toList() as T;
    }
    if (t == _i3.Hlc) {
