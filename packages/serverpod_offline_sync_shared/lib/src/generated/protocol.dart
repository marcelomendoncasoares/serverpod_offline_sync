...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i2.BaseHlc) {
      return _i2.BaseHlc.fromJson(data) as T;
    }
    if (t == _i1.getType<_i2.BaseHlc?>()) {
      return (data != null ? _i2.BaseHlc.fromJson(data) : null) as T;
    }
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'BaseHlc') {
      return deserialize<_i2.BaseHlc>(data['data']);
    }
    return super.deserializeByClassName(data);
  }
