...
abstract class UniqueCascadeChild
  ...
  static UniqueCascadeChildIncludeList includeList({
    _isd.WhereExpressionBuilder<UniqueCascadeChildTable>? where,
    int? limit,
    int? offset,
    _isd.OrderByBuilder<UniqueCascadeChildTable>? orderBy,
    _isd.OrderByListBuilder<UniqueCascadeChildTable>? orderByList,
...
class UniqueCascadeChildUpdateTable
    extends _isd.UpdateTable<UniqueCascadeChildTable> {
...
class UniqueCascadeChildTable extends _isd.Table<_isc.UuidValue?> {
...
class UniqueCascadeChildInclude extends _isd.IncludeObject {
  ...
  @override
  _isd.Table<_isc.UuidValue?> get table => UniqueCascadeChild.t;
}

class UniqueCascadeChildIncludeList extends _isd.IncludeList {
...
class UniqueCascadeChildRepository {
  ...
  Future<List<UniqueCascadeChild>> upsert(
    _isd.DatabaseSession session,
    List<UniqueCascadeChild> rows, {
    required _isd.ColumnSelections<UniqueCascadeChildTable> conflictColumns,
    _isd.ColumnSelections<UniqueCascadeChildTable>? updateColumns,
    _isd.WhereExpressionBuilder<UniqueCascadeChildTable>? updateWhere,
    _isd.Transaction? transaction,
    bool noReturn = false,
  }) async {
  ...
  Future<List<UniqueCascadeChild>> update(
    _isd.DatabaseSession session,
    List<UniqueCascadeChild> rows, {
    _isd.ColumnSelections<UniqueCascadeChildTable>? columns,
    _isd.Transaction? transaction,
    bool noReturn = false,
  }) async {
  ...
  Future<UniqueCascadeChild?> updateById(
    _isd.DatabaseSession session,
    _isc.UuidValue id, {
    required _isd.ColumnValueListBuilder<UniqueCascadeChildUpdateTable>
    columnValues,
    _isd.Transaction? transaction,
  }) async {
  ...
  Future<List<UniqueCascadeChild>> updateWhere(
    ...
    required _isd.ColumnValueListBuilder<UniqueCascadeChildUpdateTable>
    columnValues,
    required _isd.WhereExpressionBuilder<UniqueCascadeChildTable> where,
    int? limit,
    int? offset,
    _isd.OrderByBuilder<UniqueCascadeChildTable>? orderBy,
    _isd.OrderByListBuilder<UniqueCascadeChildTable>? orderByList,
