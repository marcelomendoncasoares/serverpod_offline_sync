...
abstract class UniqueCascadeReference
  ...
  static UniqueCascadeReferenceIncludeList includeList({
    _isd.WhereExpressionBuilder<UniqueCascadeReferenceTable>? where,
    int? limit,
    int? offset,
    _isd.OrderByBuilder<UniqueCascadeReferenceTable>? orderBy,
    _isd.OrderByListBuilder<UniqueCascadeReferenceTable>? orderByList,
...
class UniqueCascadeReferenceUpdateTable
    extends _isd.UpdateTable<UniqueCascadeReferenceTable> {
...
class UniqueCascadeReferenceTable extends _isd.Table<_isc.UuidValue?> {
...
class UniqueCascadeReferenceInclude extends _isd.IncludeObject {
  ...
  @override
  _isd.Table<_isc.UuidValue?> get table => UniqueCascadeReference.t;
}

class UniqueCascadeReferenceIncludeList extends _isd.IncludeList {
...
class UniqueCascadeReferenceRepository {
  ...
  Future<List<UniqueCascadeReference>> upsert(
    _isd.DatabaseSession session,
    List<UniqueCascadeReference> rows, {
    required _isd.ColumnSelections<UniqueCascadeReferenceTable> conflictColumns,
    _isd.ColumnSelections<UniqueCascadeReferenceTable>? updateColumns,
    _isd.WhereExpressionBuilder<UniqueCascadeReferenceTable>? updateWhere,
    _isd.Transaction? transaction,
    bool noReturn = false,
  }) async {
  ...
  Future<List<UniqueCascadeReference>> update(
    _isd.DatabaseSession session,
    List<UniqueCascadeReference> rows, {
    _isd.ColumnSelections<UniqueCascadeReferenceTable>? columns,
    _isd.Transaction? transaction,
    bool noReturn = false,
  }) async {
  ...
  Future<UniqueCascadeReference?> updateById(
    _isd.DatabaseSession session,
    _isc.UuidValue id, {
    required _isd.ColumnValueListBuilder<UniqueCascadeReferenceUpdateTable>
    columnValues,
    _isd.Transaction? transaction,
  }) async {
  ...
  Future<List<UniqueCascadeReference>> updateWhere(
    ...
    required _isd.ColumnValueListBuilder<UniqueCascadeReferenceUpdateTable>
    columnValues,
    required _isd.WhereExpressionBuilder<UniqueCascadeReferenceTable> where,
    int? limit,
    int? offset,
    _isd.OrderByBuilder<UniqueCascadeReferenceTable>? orderBy,
    _isd.OrderByListBuilder<UniqueCascadeReferenceTable>? orderByList,
