...
class UniqueMixedFkUpdateTable extends _isd.UpdateTable<UniqueMixedFkTable> {
...
class UniqueMixedFkTable extends _isd.Table<_isc.UuidValue?> {
...
class UniqueMixedFkInclude extends _isd.IncludeObject {
  ...
  @override
  _isd.Table<_isc.UuidValue?> get table => UniqueMixedFk.t;
}

class UniqueMixedFkIncludeList extends _isd.IncludeList {
...
class UniqueMixedFkRepository {
  ...
  Future<List<UniqueMixedFk>> upsert(
    _isd.DatabaseSession session,
    List<UniqueMixedFk> rows, {
    required _isd.ColumnSelections<UniqueMixedFkTable> conflictColumns,
    _isd.ColumnSelections<UniqueMixedFkTable>? updateColumns,
    _isd.WhereExpressionBuilder<UniqueMixedFkTable>? updateWhere,
    _isd.Transaction? transaction,
    bool noReturn = false,
  }) async {
  ...
  Future<List<UniqueMixedFk>> update(
    _isd.DatabaseSession session,
    List<UniqueMixedFk> rows, {
    _isd.ColumnSelections<UniqueMixedFkTable>? columns,
    _isd.Transaction? transaction,
    bool noReturn = false,
  }) async {
  ...
  Future<UniqueMixedFk?> updateById(
    _isd.DatabaseSession session,
    _isc.UuidValue id, {
    required _isd.ColumnValueListBuilder<UniqueMixedFkUpdateTable> columnValues,
    _isd.Transaction? transaction,
  }) async {
  ...
  Future<List<UniqueMixedFk>> updateWhere(
    _isd.DatabaseSession session, {
    required _isd.ColumnValueListBuilder<UniqueMixedFkUpdateTable> columnValues,
    required _isd.WhereExpressionBuilder<UniqueMixedFkTable> where,
    int? limit,
    int? offset,
    _isd.OrderByBuilder<UniqueMixedFkTable>? orderBy,
    _isd.OrderByListBuilder<UniqueMixedFkTable>? orderByList,
