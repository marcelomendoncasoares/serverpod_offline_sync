...
abstract class FkChainSetNullSetNullChild
  ...
  static FkChainSetNullSetNullChildIncludeList includeList({
    _is.WhereExpressionBuilder<FkChainSetNullSetNullChildTable>? where,
    int? limit,
    int? offset,
    _is.OrderByBuilder<FkChainSetNullSetNullChildTable>? orderBy,
    _is.OrderByListBuilder<FkChainSetNullSetNullChildTable>? orderByList,
...
class FkChainSetNullSetNullChildUpdateTable
    extends _is.UpdateTable<FkChainSetNullSetNullChildTable> {
...
class FkChainSetNullSetNullChildTable extends _is.Table<_is.UuidValue?> {
...
class FkChainSetNullSetNullChildInclude extends _is.IncludeObject {
  ...
  @override
  _is.Table<_is.UuidValue?> get table => FkChainSetNullSetNullChild.t;
}

class FkChainSetNullSetNullChildIncludeList extends _is.IncludeList {
...
class FkChainSetNullSetNullChildRepository {
  ...
  Future<List<FkChainSetNullSetNullChild>> upsert(
    _is.DatabaseSession session,
    List<FkChainSetNullSetNullChild> rows, {
    required _is.ColumnSelections<FkChainSetNullSetNullChildTable>
    conflictColumns,
    _is.ColumnSelections<FkChainSetNullSetNullChildTable>? updateColumns,
    _is.WhereExpressionBuilder<FkChainSetNullSetNullChildTable>? updateWhere,
    _is.Transaction? transaction,
    bool noReturn = false,
  }) async {
  ...
  Future<List<FkChainSetNullSetNullChild>> update(
    _is.DatabaseSession session,
    List<FkChainSetNullSetNullChild> rows, {
    _is.ColumnSelections<FkChainSetNullSetNullChildTable>? columns,
    _is.Transaction? transaction,
    bool noReturn = false,
  }) async {
  ...
  Future<FkChainSetNullSetNullChild?> updateById(
    _is.DatabaseSession session,
    _is.UuidValue id, {
    required _is.ColumnValueListBuilder<FkChainSetNullSetNullChildUpdateTable>
    columnValues,
    _is.Transaction? transaction,
  }) async {
  ...
  Future<List<FkChainSetNullSetNullChild>> updateWhere(
    ...
    required _is.ColumnValueListBuilder<FkChainSetNullSetNullChildUpdateTable>
    columnValues,
    required _is.WhereExpressionBuilder<FkChainSetNullSetNullChildTable> where,
    int? limit,
    int? offset,
    _is.OrderByBuilder<FkChainSetNullSetNullChildTable>? orderBy,
    _is.OrderByListBuilder<FkChainSetNullSetNullChildTable>? orderByList,
