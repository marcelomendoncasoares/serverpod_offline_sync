...
abstract class UniqueFkPair
  ...
  factory UniqueFkPair.fromJson(Map<String, dynamic> jsonSerialization) {
    return UniqueFkPair(
      ...
      leftId: jsonSerialization['leftId'] == null
          ? null
          : _is.UuidValueJsonExtension.fromJson(jsonSerialization['leftId']),
      ...
      rightId: jsonSerialization['rightId'] == null
          ? null
          : _is.UuidValueJsonExtension.fromJson(jsonSerialization['rightId']),
  ...
  static UniqueFkPairIncludeList includeList({
    _is.WhereExpressionBuilder<UniqueFkPairTable>? where,
    int? limit,
    int? offset,
    _is.OrderByBuilder<UniqueFkPairTable>? orderBy,
    _is.OrderByListBuilder<UniqueFkPairTable>? orderByList,
...
class _UniqueFkPairImpl extends UniqueFkPair {
  ...
  UniqueFkPair copyWith({
    ...
    return UniqueFkPair(
      ...
      rightId: rightId is _is.UuidValue? ? rightId : this.rightId,
...
class UniqueFkPairUpdateTable extends _is.UpdateTable<UniqueFkPairTable> {
  ...
  _is.ColumnValue<_is.UuidValue, _is.UuidValue> leftId(_is.UuidValue? value) =>
      _is.ColumnValue(
        table.leftId,
        value,
      );

  _is.ColumnValue<_is.UuidValue, _is.UuidValue> rightId(_is.UuidValue? value) =>
      _is.ColumnValue(
        table.rightId,
        value,
      );
...
class UniqueFkPairTable extends _is.Table<_is.UuidValue?> {
  UniqueFkPairTable({super.tableRelation})
    ...
    leftId = _is.ColumnUuid(
      'leftId',
      this,
    );
    rightId = _is.ColumnUuid(
      'rightId',
      this,
    );
  }
  ...
  _iensfz4m.PersonTable get right {
    ...
    _right = _is.createRelationTable(
...
class UniqueFkPairInclude extends _is.IncludeObject {
  ...
  @override
  _is.Table<_is.UuidValue?> get table => UniqueFkPair.t;
}

class UniqueFkPairIncludeList extends _is.IncludeList {
...
class UniqueFkPairRepository {
  ...
  Future<List<UniqueFkPair>> upsert(
    _is.DatabaseSession session,
    List<UniqueFkPair> rows, {
    required _is.ColumnSelections<UniqueFkPairTable> conflictColumns,
    _is.ColumnSelections<UniqueFkPairTable>? updateColumns,
    _is.WhereExpressionBuilder<UniqueFkPairTable>? updateWhere,
    _is.Transaction? transaction,
    bool noReturn = false,
  }) async {
  ...
  Future<List<UniqueFkPair>> update(
    _is.DatabaseSession session,
    List<UniqueFkPair> rows, {
    _is.ColumnSelections<UniqueFkPairTable>? columns,
    _is.Transaction? transaction,
    bool noReturn = false,
  }) async {
  ...
  Future<UniqueFkPair?> updateById(
    _is.DatabaseSession session,
    _is.UuidValue id, {
    required _is.ColumnValueListBuilder<UniqueFkPairUpdateTable> columnValues,
    _is.Transaction? transaction,
  }) async {
  ...
  Future<List<UniqueFkPair>> updateWhere(
    _is.DatabaseSession session, {
    required _is.ColumnValueListBuilder<UniqueFkPairUpdateTable> columnValues,
    required _is.WhereExpressionBuilder<UniqueFkPairTable> where,
    int? limit,
    int? offset,
    _is.OrderByBuilder<UniqueFkPairTable>? orderBy,
    _is.OrderByListBuilder<UniqueFkPairTable>? orderByList,
