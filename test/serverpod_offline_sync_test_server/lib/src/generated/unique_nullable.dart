...
abstract class UniqueNullable
  ...
  static UniqueNullableIncludeList includeList({
    _is.WhereExpressionBuilder<UniqueNullableTable>? where,
    int? limit,
    int? offset,
    _is.OrderByBuilder<UniqueNullableTable>? orderBy,
    _is.OrderByListBuilder<UniqueNullableTable>? orderByList,
...
class UniqueNullableTable extends _is.Table<_is.UuidValue?> {
...
class UniqueNullableInclude extends _is.IncludeObject {
  ...
  @override
  _is.Table<_is.UuidValue?> get table => UniqueNullable.t;
}

class UniqueNullableIncludeList extends _is.IncludeList {
...
class UniqueNullableRepository {
  ...
  Future<List<UniqueNullable>> upsert(
    _is.DatabaseSession session,
    List<UniqueNullable> rows, {
    required _is.ColumnSelections<UniqueNullableTable> conflictColumns,
    _is.ColumnSelections<UniqueNullableTable>? updateColumns,
    _is.WhereExpressionBuilder<UniqueNullableTable>? updateWhere,
    _is.Transaction? transaction,
    bool noReturn = false,
  }) async {
  ...
  Future<List<UniqueNullable>> update(
    _is.DatabaseSession session,
    List<UniqueNullable> rows, {
    _is.ColumnSelections<UniqueNullableTable>? columns,
    _is.Transaction? transaction,
    bool noReturn = false,
  }) async {
  ...
  Future<UniqueNullable?> updateById(
    _is.DatabaseSession session,
    _is.UuidValue id, {
    required _is.ColumnValueListBuilder<UniqueNullableUpdateTable> columnValues,
    _is.Transaction? transaction,
  }) async {
  ...
  Future<List<UniqueNullable>> updateWhere(
    _is.DatabaseSession session, {
    required _is.ColumnValueListBuilder<UniqueNullableUpdateTable> columnValues,
    required _is.WhereExpressionBuilder<UniqueNullableTable> where,
    int? limit,
    int? offset,
    _is.OrderByBuilder<UniqueNullableTable>? orderBy,
    _is.OrderByListBuilder<UniqueNullableTable>? orderByList,
