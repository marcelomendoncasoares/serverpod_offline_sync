...
abstract class UniqueOverlapping
  ...
  static UniqueOverlappingIncludeList includeList({
    _is.WhereExpressionBuilder<UniqueOverlappingTable>? where,
    int? limit,
    int? offset,
    _is.OrderByBuilder<UniqueOverlappingTable>? orderBy,
    _is.OrderByListBuilder<UniqueOverlappingTable>? orderByList,
...
class UniqueOverlappingUpdateTable
  ...
  _is.ColumnValue<String, String> first(String value) => _is.ColumnValue(
    table.first,
    value,
  );

  _is.ColumnValue<String, String> second(String value) => _is.ColumnValue(
    table.second,
    value,
  );

  _is.ColumnValue<String, String> third(String value) => _is.ColumnValue(
    table.third,
    value,
  );
}

class UniqueOverlappingTable extends _is.Table<_is.UuidValue?> {
  UniqueOverlappingTable({super.tableRelation})
    ...
    second = _is.ColumnString(
      'second',
      this,
    );
    third = _is.ColumnString(
      'third',
      this,
    );
  }
  ...
  late final _is.ColumnString second;

  late final _is.ColumnString third;
...
class UniqueOverlappingInclude extends _is.IncludeObject {
  ...
  @override
  _is.Table<_is.UuidValue?> get table => UniqueOverlapping.t;
}

class UniqueOverlappingIncludeList extends _is.IncludeList {
...
class UniqueOverlappingRepository {
  ...
  Future<List<UniqueOverlapping>> upsert(
    _is.DatabaseSession session,
    List<UniqueOverlapping> rows, {
    required _is.ColumnSelections<UniqueOverlappingTable> conflictColumns,
    _is.ColumnSelections<UniqueOverlappingTable>? updateColumns,
    _is.WhereExpressionBuilder<UniqueOverlappingTable>? updateWhere,
    _is.Transaction? transaction,
    bool noReturn = false,
  }) async {
  ...
  Future<List<UniqueOverlapping>> update(
    _is.DatabaseSession session,
    List<UniqueOverlapping> rows, {
    _is.ColumnSelections<UniqueOverlappingTable>? columns,
    _is.Transaction? transaction,
    bool noReturn = false,
  }) async {
  ...
  Future<UniqueOverlapping?> updateById(
    _is.DatabaseSession session,
    _is.UuidValue id, {
    required _is.ColumnValueListBuilder<UniqueOverlappingUpdateTable>
    columnValues,
    _is.Transaction? transaction,
  }) async {
  ...
  Future<List<UniqueOverlapping>> updateWhere(
    ...
    required _is.ColumnValueListBuilder<UniqueOverlappingUpdateTable>
    columnValues,
    required _is.WhereExpressionBuilder<UniqueOverlappingTable> where,
    int? limit,
    int? offset,
    _is.OrderByBuilder<UniqueOverlappingTable>? orderBy,
    _is.OrderByListBuilder<UniqueOverlappingTable>? orderByList,
