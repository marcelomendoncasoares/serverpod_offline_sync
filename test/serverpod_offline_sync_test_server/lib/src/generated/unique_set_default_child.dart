...
abstract class UniqueSetDefaultChild
  ...
  factory UniqueSetDefaultChild.fromJson(
    ...
    return UniqueSetDefaultChild(
      ...
      parent: jsonSerialization['parent'] == null
          ? null
          : _ixxccm81.Protocol().deserialize<_iytblq2r.Town>(
  ...
  static UniqueSetDefaultChildIncludeList includeList({
    _is.WhereExpressionBuilder<UniqueSetDefaultChildTable>? where,
    int? limit,
    int? offset,
    _is.OrderByBuilder<UniqueSetDefaultChildTable>? orderBy,
    _is.OrderByListBuilder<UniqueSetDefaultChildTable>? orderByList,
...
class UniqueSetDefaultChildTable extends _is.Table<_is.UuidValue?> {
...
class UniqueSetDefaultChildInclude extends _is.IncludeObject {
  ...
  @override
  _is.Table<_is.UuidValue?> get table => UniqueSetDefaultChild.t;
}

class UniqueSetDefaultChildIncludeList extends _is.IncludeList {
...
class UniqueSetDefaultChildRepository {
  ...
  Future<List<UniqueSetDefaultChild>> upsert(
    _is.DatabaseSession session,
    List<UniqueSetDefaultChild> rows, {
    required _is.ColumnSelections<UniqueSetDefaultChildTable> conflictColumns,
    _is.ColumnSelections<UniqueSetDefaultChildTable>? updateColumns,
    _is.WhereExpressionBuilder<UniqueSetDefaultChildTable>? updateWhere,
    _is.Transaction? transaction,
    bool noReturn = false,
  }) async {
  ...
  Future<List<UniqueSetDefaultChild>> update(
    _is.DatabaseSession session,
    List<UniqueSetDefaultChild> rows, {
    _is.ColumnSelections<UniqueSetDefaultChildTable>? columns,
    _is.Transaction? transaction,
    bool noReturn = false,
  }) async {
  ...
  Future<UniqueSetDefaultChild?> updateById(
    _is.DatabaseSession session,
    _is.UuidValue id, {
    required _is.ColumnValueListBuilder<UniqueSetDefaultChildUpdateTable>
    columnValues,
    _is.Transaction? transaction,
  }) async {
  ...
  Future<List<UniqueSetDefaultChild>> updateWhere(
    ...
    required _is.ColumnValueListBuilder<UniqueSetDefaultChildUpdateTable>
    columnValues,
    required _is.WhereExpressionBuilder<UniqueSetDefaultChildTable> where,
    int? limit,
    int? offset,
    _is.OrderByBuilder<UniqueSetDefaultChildTable>? orderBy,
    _is.OrderByListBuilder<UniqueSetDefaultChildTable>? orderByList,
