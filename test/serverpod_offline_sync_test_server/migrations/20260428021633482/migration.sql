...
-- ACTION DROP TABLE
--
DROP TABLE "crdt_workers";

--
-- ACTION ALTER TABLE
--
ALTER TABLE "crdt_data_fields" DROP COLUMN "workerId";
--
-- ACTION ALTER TABLE
--
ALTER TABLE "crdt_data_rows" DROP COLUMN "workerId";
--
-- ACTION ALTER TABLE
--
ALTER TABLE "crdt_data_tombstone" DROP COLUMN "workerId";
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_offline_sync_test', '20260428021633482', (unixepoch('now', 'subsecond') * 1000))
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260428021633482', "timestamp" = (unixepoch('now', 'subsecond') * 1000);
...
--
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_offline_sync', '20260428021559070', (unixepoch('now', 'subsecond') * 1000))
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260428021559070', "timestamp" = (unixepoch('now', 'subsecond') * 1000);
