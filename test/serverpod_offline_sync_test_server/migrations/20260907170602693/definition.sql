...
--
-- Class NullableSetDefaultChild as table nullable_set_default_child
--
CREATE TABLE "nullable_set_default_child" (
    "id" BLOB PRIMARY KEY DEFAULT (unhex(printf('%012x', CAST(unixepoch('now', 'subsecond') * 1000 AS INTEGER)) || '7' || substr(hex(randomblob(2)), 2, 3) || substr('89AB', 1 + (abs(random()) % 4), 1) || substr(hex(randomblob(8)), 2, 15))),
    "scopeId" INTEGER,
    "name" TEXT NOT NULL,
    "parentId" BLOB,
    CONSTRAINT "nullable_set_default_child_fk_0" FOREIGN KEY ("scopeId") REFERENCES "crdt_scopes" ("id") ON DELETE CASCADE ON UPDATE NO ACTION,
...
--
-- Class RequiredCascadeChild as table required_cascade_child
--
CREATE TABLE "required_cascade_child" (
    "id" BLOB PRIMARY KEY DEFAULT (unhex(printf('%012x', CAST(unixepoch('now', 'subsecond') * 1000 AS INTEGER)) || '7' || substr(hex(randomblob(2)), 2, 3) || substr('89AB', 1 + (abs(random()) % 4), 1) || substr(hex(randomblob(8)), 2, 15))),
    "scopeId" INTEGER,
    "name" TEXT NOT NULL,
    "parentId" BLOB NOT NULL,
    CONSTRAINT "required_cascade_child_fk_0" FOREIGN KEY ("scopeId") REFERENCES "crdt_scopes" ("id") ON DELETE CASCADE ON UPDATE NO ACTION,
...
--
-- Class RequiredNoActionChild as table required_no_action_child
--
CREATE TABLE "required_no_action_child" (
    "id" BLOB PRIMARY KEY DEFAULT (unhex(printf('%012x', CAST(unixepoch('now', 'subsecond') * 1000 AS INTEGER)) || '7' || substr(hex(randomblob(2)), 2, 3) || substr('89AB', 1 + (abs(random()) % 4), 1) || substr(hex(randomblob(8)), 2, 15))),
    "scopeId" INTEGER,
    "name" TEXT NOT NULL,
    "parentId" BLOB NOT NULL,
    CONSTRAINT "required_no_action_child_fk_0" FOREIGN KEY ("scopeId") REFERENCES "crdt_scopes" ("id") ON DELETE CASCADE ON UPDATE NO ACTION,
...
--
-- Class UniqueCascadeReference as table unique_cascade_reference
--
CREATE TABLE "unique_cascade_reference" (
    "id" BLOB PRIMARY KEY DEFAULT (unhex(printf('%012x', CAST(unixepoch('now', 'subsecond') * 1000 AS INTEGER)) || '7' || substr(hex(randomblob(2)), 2, 3) || substr('89AB', 1 + (abs(random()) % 4), 1) || substr(hex(randomblob(8)), 2, 15))),
    "scopeId" INTEGER,
    "name" TEXT NOT NULL,
    "parentId" BLOB,
    CONSTRAINT "unique_cascade_reference_fk_0" FOREIGN KEY ("scopeId") REFERENCES "crdt_scopes" ("id") ON DELETE CASCADE ON UPDATE NO ACTION,
...
--
-- Class UniqueFkPair as table unique_fk_pair
--
...
--
-- Class UniqueMixedFk as table unique_mixed_fk
--
...
--
-- Class UniqueNullable as table unique_nullable
--
...
--
-- Class UniqueOverlapping as table unique_overlapping
--
...
--
-- Class UniqueSetDefaultChild as table unique_set_default_child
--
CREATE TABLE "unique_set_default_child" (
    "id" BLOB PRIMARY KEY DEFAULT (unhex(printf('%012x', CAST(unixepoch('now', 'subsecond') * 1000 AS INTEGER)) || '7' || substr(hex(randomblob(2)), 2, 3) || substr('89AB', 1 + (abs(random()) % 4), 1) || substr(hex(randomblob(8)), 2, 15))),
    "scopeId" INTEGER,
    "name" TEXT NOT NULL,
    "parentId" BLOB DEFAULT (X'550e8400e29b41d4a716446655440000'),
    CONSTRAINT "unique_set_default_child_fk_0" FOREIGN KEY ("scopeId") REFERENCES "crdt_scopes" ("id") ON DELETE CASCADE ON UPDATE NO ACTION,
...
--
-- Class CrdtDataAttemptedValue as table crdt_data_attempted_value
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_offline_sync_test', '20260907170602693', (unixepoch('now', 'subsecond') * 1000))
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260907170602693', "timestamp" = (unixepoch('now', 'subsecond') * 1000);
