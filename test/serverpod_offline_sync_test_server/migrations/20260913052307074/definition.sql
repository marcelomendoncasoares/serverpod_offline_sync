...
--
-- Class SharedChild as table shared_child
--
...
--
-- Class SharedParent as table shared_parent
--
...
INSERT INTO "serverpod_sqlite_schema" VALUES
    ...
    ('shared_child', 'id', 'uuid', NULL),
    ('shared_child', 'parentId', 'uuid', NULL),
    ('shared_parent', 'id', 'uuid', NULL),
    ('town', 'id', 'uuid', NULL),
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_offline_sync_test', '20260913052307074', (unixepoch('now', 'subsecond') * 1000))
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260913052307074', "timestamp" = (unixepoch('now', 'subsecond') * 1000);
