...
--
-- Class OfflineSyncIntegrityViolation as table offline_sync_integrity_violations
--
...
--
-- Class OfflineSyncSpaceCacheVersion as table offline_sync_space_cache_versions
--
...
--
-- Class OfflineSyncSpaceMember as table offline_sync_space_members
--
...
--
-- Class OfflineSyncSpaceNode as table offline_sync_space_nodes
--
...
--
-- Class OfflineSyncSpace as table offline_sync_spaces
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_offline_sync_test', '20260922160200314', (unixepoch('now', 'subsecond') * 1000))
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260922160200314', "timestamp" = (unixepoch('now', 'subsecond') * 1000);
