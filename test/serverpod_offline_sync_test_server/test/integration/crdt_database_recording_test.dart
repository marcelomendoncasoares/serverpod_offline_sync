  ...
  withServerpod(
    ...
    (sessionBuilder, _) {
      ...
      setUp(() async {
        ...
        await seedCrdtUserAndPersonSchema(inner);
        await seedCrdtSchemaColumnsForPerson(inner);
        session = CrdtDatabaseSession.wraps(inner, persistentUserId: testCrdtUserId);
      });
